...
class SalaryDecrementAmountController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('salary-loan.decrement.amount', compact('campuses', 'accountants', 'currentDate'));
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        SalaryDecrementAmount::create($validated);

        return redirect()
            ->route('salary-loan.decrement.amount')
            ->with('success', 'Salary decrement by amount created successfully!');
    }
}
