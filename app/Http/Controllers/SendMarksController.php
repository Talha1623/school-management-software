...
class SendMarksController extends Controller
{
    /**
     * Display the send marks to parents for practical test page.
     */
    public function practical(Request $request): View
    {
        ...
        return view('test.send-marks.practical', compact('campuses', 'classes', 'sections', 'subjects', 'tests'));
    }
    ...
    /**
     * Display the send marks to parents for combine result page.
     */
    public function combined(Request $request): View
    {
        ...
        return view('test.send-marks.combined', compact('campuses', 'classes', 'sections', 'testTypes', 'sessions'));
    }

    /**
     * Get sections based on class (AJAX) for combined page.
     */
    public function getSectionsCombined(Request $request): JsonResponse
    {
    ...
    private function getTestTypes()
    {
        ...
        return $testTypes->isEmpty() ? collect(['Quiz', 'Mid Term', 'Final Term', 'Assignment', 'Project', 'Oral Test']) : $testTypes;
    }
