...
class SalaryIncrementPercentageController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('salary-loan.increment.percentage', compact('campuses', 'accountants', 'currentDate'));
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        SalaryIncrementPercentage::create($validated);

        return redirect()
            ->route('salary-loan.increment.percentage')
            ->with('success', 'Salary increment by percentage created successfully!');
    }
}
