...
/* Also apply the same effect for FIRST-LEVEL dropdowns (Staff/Admin menus mostly use this)
   EXCEPT the "Dashboard" root wrapper in Super Admin (it shouldn't show the left border line) */
.menu-vertical .menu-inner > .menu-item.open:not(.dashboard-root-menu) > .menu-sub,
.menu-vertical .menu-inner > .menu-item.open:not(.dashboard-root-menu) > ul.menu-sub {
    display: block !important;
    position: relative;
    margin-left: 12px !important;
    padding-left: 10px !important;
