...
<body>
    <div class="header">
        <h3>Admissions Today Report</h3>
        <p class="mb-0">Date: {{ today()->format('d-m-Y') }}</p>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
            <tr>
                <td colspan="8" class="text-center">No admissions found for today.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
    ...
    <div style="margin-top: 20px;">
        <p><strong>Total Admissions Today:</strong> {{ $students->count() }}</p>
    </div>
...
@section('title', 'Admissions Today Report')

@section('content')
<!-- Print Header (only visible when printing) -->
<div class="print-header d-none">
    <h3 style="margin: 0; color: #003471;">Admissions Today Report</h3>
    <p style="margin: 5px 0 0 0;">Date: {{ today()->format('d-m-Y') }}</p>
</div>
    ...
    <div class="col-12">
        <div class="card bg-white border border-white rounded-10 p-3 mb-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h4 class="mb-0 fs-16 fw-semibold">Admissions Today Report</h4>
                <a href="{{ route('admission.report.today', ['print' => 1]) }}" target="_blank" class="btn btn-sm btn-primary">
                            ...
                            <tr>
                                <td colspan="8" class="text-center py-4">
                                    <div class="d-flex flex-column align-items-center">
                                        ...
                                        <p class="text-muted mt-2 mb-0">No admissions found for today.</p>
                                    </div>
                                </td>
                            </tr>
                            @endforelse
            ...
            <div class="mt-3">
                <p class="mb-0"><strong>Total Admissions Today:</strong> {{ $students->count() }}</p>
            </div>
        </div>
    </div>
</div>
