...
@section('title', 'SMS to Specific Number')
    ...
    <div class="col-12">
        <div class="card bg-white border border-white rounded-10 p-3 mb-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h4 class="mb-0 fs-16 fw-semibold">SMS to Specific Number</h4>
            </div>
            ...
            <form action="#" method="POST" id="smsForm">
                ...
                <div class="row g-2 mb-3 align-items-end">
                    <!-- Number -->
                    <div class="col-md-12">
                        <label for="number" class="form-label mb-1 fs-12 fw-semibold" style="color: #003471;">Number</label>
                        <div class="input-group input-group-sm">
                            <span class="input-group-text" style="background-color: #f0f4ff; border-color: #e0e7ff; color: #003471;">
                                <span class="material-symbols-outlined" style="font-size: 15px;">phone</span>
                            </span>
                            <input type="tel" class="form-control" id="number" name="number" placeholder="Enter phone number" style="height: 32px; border-left: none;">
                        </div>
                    </div>
                </div>
