                            ...
                            @empty
                                <tr>
                                    <td colspan="9" class="text-center text-muted py-5">
                                        ...
                                        <p class="mt-2 mb-1">No staff birthdays today ({{ $todayDate->format('d M') }}).</p>
                                        <p class="mb-0 fs-13">Staff will appear here automatically on their saved birthday date.</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
