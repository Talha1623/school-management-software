...
<div class="print-container">
  <div class="header">
    ...
    <div class="report-title">Events List</div>
  </div>
  ...
  <table>
    <thead>
      <tr>
        ...
        <th style="width:180px;">Event Title</th>
        <th>Event Details</th>
    ...
    <tbody>
      ...
      @empty
        <tr>
          <td colspan="5" class="center">No events found</td>
        </tr>
      @endforelse
    </tbody>
  </table>
  ...
  <div class="footer">
    <div><strong>Total:</strong> {{ $events->count() }}</div>
