...
<head>
    ...
    <title>School Leaving Certificate - {{ $student->student_name }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="certificate-container">
        <div class="certificate-border">
            ...
            <!-- Title -->
            <h2 class="certificate-title">School Leaving Certificate</h2>
            ...
            <div class="certificate-body">
                ...
                <div class="student-details">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value">{{ $student->home_address }}</span>
                    </div>
                    @endif
                </div>

                <p style="margin-top: 30px;">The above-mentioned student has left this institution on <strong>{{ $currentDate }}</strong> and all dues have been cleared.</p>

                <p style="margin-top: 20px;">This certificate is issued on the request of the student/parent for official purposes.</p>
            </div>
