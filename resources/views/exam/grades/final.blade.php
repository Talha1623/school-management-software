...
@section('title', 'Exam Grades - For Final Exam')
        ...
        <div class="card bg-white border border-white rounded-10 p-3 mb-4">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3 mb-3 p-3 rounded-8" style="background-color: #f8f9fa; border: 1px solid #e9ecef;">
                ...
                <div class="d-flex align-items-center gap-2 flex-wrap">
                    ...
                    <div class="d-flex gap-2">
                        <a href="{{ route('exam.grades.final.export', ['format' => 'excel']) }}{{ request()->has('search') ? '?search=' . request('search') : '' }}" class="btn btn-sm px-2 py-1 export-btn excel-btn">
                            <span class="material-symbols-outlined" style="font-size: 14px; vertical-align: middle;">description</span>
                            <span>Excel</span>
                        </a>
                        <a href="{{ route('exam.grades.final.export', ['format' => 'pdf']) }}{{ request()->has('search') ? '?search=' . request('search') : '' }}" class="btn btn-sm px-2 py-1 export-btn pdf-btn" target="_blank">
            ...
            <div class="mb-2 p-2 rounded-8" style="background: linear-gradient(135deg, #003471 0%, #004a9f 100%);">
                <h5 class="mb-0 text-white fs-15 fw-semibold d-flex align-items-center gap-2">
                    ...
                    <span>Final Exam Grades List</span>
                </h5>
            </div>
            ...
            @if(request('search'))
                <div class="search-results-info">
                    ...
                    @endif
                    <a href="{{ route('exam.grades.final') }}" class="text-decoration-none ms-2" style="color: #003471;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <div class="d-inline-flex gap-1">
                                                ...
                                                <form id="delete-form-{{ $grade->id }}" action="{{ route('exam.grades.final.destroy', $grade->id) }}" method="POST" class="d-none">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </div>
...
<div class="modal fade" id="gradeModal" tabindex="-1" aria-labelledby="gradeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 12px; overflow: hidden;">
            ...
            <form id="gradeForm" method="POST" action="{{ route('exam.grades.final.store') }}">
                @csrf
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-sm grade-input-group">
                                ...
                                <input type="text" class="form-control grade-input" name="name" id="name" placeholder="Enter grade name (e.g., A+, A, B+)" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-sm grade-input-group">
                                <span class="input-group-text" style="background-color: #f0f4ff; border-color: #e0e7ff; color: #003471;">
                                    <span class="material-symbols-outlined" style="font-size: 15px;">percent</span>
                                </span>
...
function editGrade(id, campus, name, fromPercentage, toPercentage, session) {
    ...
    document.getElementById('gradeForm').action = '{{ route("exam.grades.final.update", ":id") }}'.replace(':id', id);
