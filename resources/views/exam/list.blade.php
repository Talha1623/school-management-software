                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <div class="d-inline-flex gap-1">
                                                <button type="button" class="btn btn-sm btn-primary px-2 py-0" title="Edit" onclick="editExam({{ $exam->id }}, '{{ addslashes($exam->campus) }}', '{{ addslashes($exam->exam_name) }}', '{{ addslashes($exam->description ?? '') }}', '{{ $exam->exam_date->format('Y-m-d') }}', '{{ addslashes($exam->session) }}')">
                                                    <span class="material-symbols-outlined" style="font-size: 14px; color: white;">edit</span>
                                                </button>
                                                <button type="button" class="btn btn-sm btn-danger px-2 py-0" title="Delete" onclick="if(confirm('Are you sure you want to delete this exam?')) { document.getElementById('delete-form-{{ $exam->id }}').submit(); }">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 12px; overflow: hidden;">
            <div class="modal-header text-white p-3" style="background: linear-gradient(135deg, #003471 0%, #004a9f 100%); border: none;">
                <h5 class="modal-title fs-15 fw-semibold mb-0 d-flex align-items-center gap-2" id="examModalLabel">
...
function resetForm() {
    ...
    document.getElementById('examModalLabel').innerHTML = '<span class="material-symbols-outlined" style="font-size: 20px;">quiz</span><span>Add New Exam</span>';
}
...
function editExam(id, campus, examName, description, examDate, session) {
    ...
    document.getElementById('examModalLabel').innerHTML = '<span class="material-symbols-outlined" style="font-size: 20px;">edit</span><span>Edit Exam</span>';
