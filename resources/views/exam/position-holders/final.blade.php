...
@section('title', 'Position Holders - For Final Result')
    ...
    <div class="col-12">
        <div class="card bg-white border border-white rounded-10 p-3 mb-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h4 class="mb-0 fs-16 fw-semibold">Position Holders - For Final Result</h4>
            </div>

            <!-- Filter Form -->
            <form action="{{ route('exam.position-holders.final') }}" method="GET" id="filterForm">
...
function printTable() {
    ...
    document.body.innerHTML = `
        <div style="padding: 20px;">
            <h3 style="text-align: center; margin-bottom: 20px; color: #003471;">Position Holders - Final Result</h3>
            ${printContents}
        </div>
    `;
