                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="card bg-light border-0 rounded-10 p-3 mb-2">
                            ...
                            <label for="decrease" class="form-label mb-1 fs-12 fw-semibold" style="color: #003471;">Salary Decrease (Amount) <span class="text-danger">*</span></label>
                            <div class="input-group input-group-sm decrement-input-group">
                                <span class="input-group-text" style="background-color: #f0f4ff; border-color: #e0e7ff; color: #003471;">
                    ...
                    <div class="col-md-6" id="feesDecrementContainer" style="display: none;">
                        <div class="card bg-light border-0 rounded-10 p-3 mb-2">
                            ...
                            <div class="input-group input-group-sm decrement-input-group mb-2">
                                ...
                                <input type="number" class="form-control decrement-input" name="absent_fees_decrement" id="absent_fees_decrement" placeholder="Enter amount (optional)" step="0.01" min="0" style="height: 36px;">
                            </div>
                            ...
                            <div class="input-group input-group-sm decrement-input-group mb-2">
                                ...
                                <input type="number" class="form-control decrement-input" name="late_fees_decrement" id="late_fees_decrement" placeholder="Enter amount (optional)" step="0.01" min="0" style="height: 36px;">
                            </div>
                            ...
                            <div class="input-group input-group-sm decrement-input-group">
                                ...
                                <input type="number" class="form-control decrement-input" name="early_exit_fees_decrement" id="early_exit_fees_decrement" placeholder="Enter amount (optional)" step="0.01" min="0" style="height: 36px;">
                            </div>
                            <small class="text-muted" style="font-size: 10px;">Only apply if amount is entered, otherwise fees will not be decremented</small>
                        </div>
                    </div>
...
function loadStaffByCampus() {
    ...
    fetch(`{{ route('salary-loan.decrement.amount.get-staff-by-campus') }}?campus=${encodeURIComponent(campus)}&salary_type=${encodeURIComponent(salaryType)}`, {
        headers: {
...
function updateSalaryPreview() {
    ...
    if (amount > 0) {
        checkboxes.forEach(checkbox => {
            ...
            // Update fees preview - only show if manual decrement amount is provided
            ...
            if (absentFeesSpan && absentFeesDecrement !== null && absentFeesDecrement > 0) {
                ...
                if (originalAbsent > 0) {
                    const newAbsent = Math.max(0, originalAbsent - absentFeesDecrement);
            ...
            if (lateFeesSpan && lateFeesDecrement !== null && lateFeesDecrement > 0) {
                ...
                if (originalLate > 0) {
                    const newLate = Math.max(0, originalLate - lateFeesDecrement);
            ...
            if (earlyExitFeesSpan && earlyExitFeesDecrement !== null && earlyExitFeesDecrement > 0) {
                ...
                if (originalEarlyExit > 0) {
                    const newEarlyExit = Math.max(0, originalEarlyExit - earlyExitFeesDecrement);
