    ...
    <div class="col-12">
        <div class="card bg-white border border-white rounded-10 p-3 mb-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h4 class="mb-0 fs-16 fw-semibold">Decrement By Percentage</h4>
            </div>
            ...
            <form action="{{ route('salary-loan.decrement.percentage.store') }}" method="POST" id="decrementPercentageForm" onsubmit="return validateForm()">
                @csrf
...
function updateSalaryPreview() {
    ...
    if (percentage > 0) {
        checkboxes.forEach(checkbox => {
            ...
            const newSalary = Math.max(0, currentSalary - (currentSalary * (percentage / 100)));
