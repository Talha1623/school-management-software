                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="card bg-light border-0 rounded-10 p-3 mb-2">
                            ...
                            <label for="increase" class="form-label mb-1 fs-12 fw-semibold" style="color: #003471;">Increase (%) <span class="text-danger">*</span></label>
                            <div class="input-group input-group-sm increment-input-group">
                                <span class="input-group-text" style="background-color: #f0f4ff; border-color: #e0e7ff; color: #003471;">
...
function loadStaffByCampus() {
    ...
    fetch(`{{ route('salary-loan.increment.percentage.get-staff-by-campus') }}?campus=${encodeURIComponent(campus)}`, {
        headers: {
