    ...
    <div class="receipt-container">
        ...
        <div class="amount-section">
            ...
            <div class="amount-row">
                ...
                <span class="info-value">{{ $formatMoney($salary->basic ?? 0) }}</span>
            </div>
            
            @if(($salary->bonus_amount ?? 0) > 0)
            <div class="amount-row">
                <span class="amount-label">Bonus:</span>
                <span class="info-value" style="color: #28a745;">+ {{ $formatMoney($salary->bonus_amount ?? 0) }}</span>
            </div>
            @endif
            ...
            <div class="amount-row">
                ...
                <span class="info-value" style="color: #dc3545;">- {{ $formatMoney($salary->deduction_amount ?? 0) }}</span>
            </div>
            @endif
            ...
            <div class="amount-row">
                ...
                <span class="info-value" style="color: #dc3545;">- {{ $formatMoney($salary->loan_repayment ?? 0) }}</span>
            </div>
            @endif
            ...
            <div class="amount-row" style="border-top: 1px solid #003471; margin-top: 10px; padding-top: 10px;">
                ...
                <span class="info-value" style="font-weight: bold; font-size: 18px;">{{ $formatMoney($generatedDisplay) }}</span>
            </div>
            
            <div class="amount-row" style="border-top: 2px solid #003471; margin-top: 15px; padding-top: 15px;">
                <span class="amount-label">Amount Paid:</span>
                <span class="amount-value">{{ $formatMoney($amountPaidDisplay) }}</span>
            </div>
            ...
            <div class="amount-row" style="margin-top: 10px; padding-top: 10px; border-top: 1px solid #ddd; font-size: 12px; color: #666;">
                ...
                <span class="info-value" style="font-style: italic;">Loan repayment of {{ $formatMoney($salary->loan_repayment ?? 0) }} has been deducted from your salary.</span>
            </div>
            @endif
        </div>
