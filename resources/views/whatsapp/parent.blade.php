...
@section('title', 'Message to Parents')
    ...
    <div class="col-12">
        <div class="card bg-white border border-white rounded-10 p-3 mb-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h4 class="mb-0 fs-16 fw-semibold">Message to Parents</h4>
            </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <div class="input-group">
                            ...
                            <textarea class="form-control" id="sms_message" name="sms_message" rows="6" placeholder="Type your message here..." style="border-left: none; resize: vertical;"></textarea>
                        </div>
                    </div>
                </div>
