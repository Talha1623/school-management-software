...
<body>
    <div class="header">
        <div>
            <h1 class="title">Family Tree Report</h1>
            <p class="subtitle">Total Parents: {{ $parents->count() }}</p>
        </div>
        <div>
    ...
    <table>
        ...
        <tbody>
            @forelse($parents as $index => $parent)
                <tr>
                    ...
                    <td>
                        ...
                        <div class="subtitle">ID: {{ $parent->id_card_number ?? 'N/A' }}</div>
                    </td>
                    <td>
            ...
            @empty
                <tr>
                    <td colspan="3" class="empty">No parents found.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
