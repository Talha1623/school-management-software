...
<head>
    ...
    <title>Parent Credit Report</title>
    <style>
...
<div class="print-container">
    <div class="header-section">
        ...
        <div class="report-title">Parent Credit Report</div>
    ...
    <table>
        ...
        <tr>
            <th style="width:4%;">#</th>
            <th style="width:36%;">Parent</th>
            <th style="width:12%;">Students</th>
            <th class="text-right" style="width:18%;">Total Paid</th>
        </tr>
        </thead>
        <tbody>
        @forelse($rows as $index => $row)
            <tr>
                ...
                <td class="text-right">{{ number_format($row['paid_total'] ?? 0, 2) }}</td>
            </tr>
        @empty
            <tr>
                <td colspan="4" style="text-align:center;color:#6b7280;">No credit data found.</td>
            </tr>
        @endforelse
        </tbody>
    </table>
    ...
    <div class="footer-section">
        <div>
            <div><strong>Total Parents (listed):</strong> {{ $rows->count() }}</div>
            <div><strong>Grand total paid:</strong> {{ number_format($grandTotal ?? 0, 2) }}</div>
        </div>
