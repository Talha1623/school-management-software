...
@section('title', 'Notification to Student')
    ...
    <div class="col-12">
        <div class="card bg-white border border-white rounded-10 p-3 mb-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h4 class="mb-0 fs-16 fw-semibold">Notification to Student</h4>
            </div>
            ...
            <form action="{{ route('notification.student.send') }}" method="POST" id="notificationForm">
                @csrf
