                            ...
                            @forelse($deletedFees as $deletedFee)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="text-muted" style="font-size: 11px;">{{ $deletedFee->student_code }}</div>
                                    </td>
                                    <td>
                                        <span class="text-muted">{{ $deletedFee->parent_name ?? 'N/A' }}</span>
                                    </td>
                                    <td>
                                        <span class="text-muted">{{ trim(($deletedFee->class ?? '') . '/' . ($deletedFee->section ?? ''), '/') ?: 'N/A' }}</span>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-end">
                                        <form action="{{ route('accounting.parent-wallet.deleted-fees.restore', $deletedFee->id) }}" method="POST" style="display: inline-block;" onsubmit="return confirm('Are you sure you want to restore this fee?');">
                                            @csrf
                                            @method('POST')
