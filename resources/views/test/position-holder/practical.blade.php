...
@section('title', 'Position Holder - For Practical Test')
    ...
    <div class="col-12">
        <div class="card bg-white border border-white rounded-10 p-3 mb-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h4 class="mb-0 fs-16 fw-semibold">Position Holder - For Practical Test</h4>
            </div>

            <!-- Filter Form -->
            <form action="{{ route('test.position-holder.practical') }}" method="GET" id="filterForm">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        @if($index == 0)
                                            <span class="badge bg-warning text-dark" style="font-size: 14px; padding: 6px 10px;">
                                                <span class="material-symbols-outlined" style="font-size: 16px; vertical-align: middle;">emoji_events</span>
                                                1st
                                            </span>
                                        @elseif($index == 1)
                                            <span class="badge bg-secondary text-white" style="font-size: 14px; padding: 6px 10px;">
                                                <span class="material-symbols-outlined" style="font-size: 16px; vertical-align: middle;">emoji_events</span>
                                                2nd
                                            </span>
                                        @elseif($index == 2)
