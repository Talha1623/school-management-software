        ...
        <div class="modal-content border-0 shadow-lg" style="border-radius: 12px; overflow: hidden;">
            ...
            <form id="gradeForm" method="POST" action="{{ route('test.assign-grades.combined.store') }}">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-sm test-input-group">
                                ...
                                <input type="text" class="form-control test-input" name="name" id="name" placeholder="Enter grade name (e.g., A+, A, B+)" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-sm test-input-group">
                                ...
                                <input type="number" class="form-control test-input" name="from_percentage" id="from_percentage" placeholder="From percentage" min="0" max="100" step="0.01" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-sm test-input-group">
                                ...
                                <input type="number" class="form-control test-input" name="to_percentage" id="to_percentage" placeholder="To percentage" min="0" max="100" step="0.01" required>
                            </div>
                        </div>
                        <div class="col-md-12">
                ...
                <div class="modal-footer p-3 border-top">
                    <button type="button" class="btn btn-sm btn-secondary rounded-8" data-bs-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn btn-sm rounded-8" style="background: linear-gradient(135deg, #003471 0%, #004a9f 100%); color: white; border: none;">Save Grade</button>
                </div>
            </form>
        </div>
    </div>
