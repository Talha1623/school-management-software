                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" class="form-control form-control-sm" style="width: 100px; display: inline-block;" placeholder="Enter marks" min="0" max="100" step="0.01">
                                    </td>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-success px-2 py-0" title="Save Marks">
                                            <span class="material-symbols-outlined" style="font-size: 14px; color: white;">save</span>
                                        </button>
                                    </td>
                                </tr>
                                @empty
                            ...
                            <tfoot>
                                <tr class="fw-bold" style="background-color: #f8f9fa;">
                                    <td colspan="6" class="text-end">Total Students:</td>
