...
<head>
    ...
    <title>Print Marksheets - Combine Test</title>
...
@section('title', 'Print Marksheets - Combine Test')
    ...
    <div class="col-12">
        <div class="card bg-white border border-white rounded-10 p-3 mb-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h4 class="mb-0 fs-16 fw-semibold">Print Marksheets - Combine Test</h4>
            </div>

            <form id="printMarksheetsForm" method="GET" action="{{ route('test.print-marksheets.combine') }}" target="_blank">
                ...
                <div class="row g-2 mb-3 align-items-end">
                    ...
                    <!-- Test Type -->
                    <div class="col-md-2">
                        <label for="test_type" class="form-label mb-1 fs-12 fw-semibold" style="color: #003471;">Test Type</label>
                        <select class="form-select form-select-sm" id="test_type" name="test_type" style="height: 32px;">
                    ...
                    <!-- From Date -->
                    <div class="col-md-2">
                        <label for="from_date" class="form-label mb-1 fs-12 fw-semibold" style="color: #003471;">From Date</label>
                        <input type="date" class="form-control form-control-sm" id="from_date" name="from_date" value="{{ $filterFromDate }}" style="height: 32px;">
                    </div>

                    <!-- To Date -->
                    <div class="col-md-2">
                        <label for="to_date" class="form-label mb-1 fs-12 fw-semibold" style="color: #003471;">To Date</label>
                        <input type="date" class="form-control form-control-sm" id="to_date" name="to_date" value="{{ $filterToDate }}" style="height: 32px;">
                    </div>
        ...
        <div class="marksheet-card page-break">
            ...
            <div class="text-center mb-3">
                ...
                <div class="badge rounded-pill text-white mt-2 px-4 py-2" style="background: linear-gradient(135deg, #28a745 0%, #20c997 100%); font-size: 14px;">
                    Result Card {{ $combinedTestName ?? 'Combine Test' }} - Dated: {{ date('d-M-Y') }}
                </div>
            </div>
            ...
            <div class="row g-2 align-items-center mb-3">
                <div class="col-md-8">
                    <div class="row g-2">
                        ...
                        <div class="col-md-6">
                            <div class="info-item">
                                <strong>Campus / Session:</strong> {{ $student->campus ?? 'N/A' }} / {{ $student->session ?? $runningSession ?? 'N/A' }}
                            </div>
                        </div>
                    </div>
                </div>
