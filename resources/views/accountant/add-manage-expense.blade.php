...
@section('title', 'Add Management Expense - Accountant')
        ...
        <div class="card bg-white border border-white rounded-10 p-3 mb-4">
            ...
            <div class="card border-0 shadow-sm mb-3" style="border-radius: 8px; overflow: hidden;">
                <div class="card-body p-3">
                    <form action="{{ route('accountant.add-manage-expense') }}" method="GET" id="filterForm">
                        ...
                        <div class="row g-3 align-items-end">
                            ...
                            <!-- Clear Filter Button -->
                            <div class="col-md-2">
                                <a href="{{ route('accountant.add-manage-expense') }}" class="btn btn-sm w-100 btn-outline-secondary" style="height: 32px;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <div class="d-inline-flex gap-1">
                                                ...
                                                <a href="{{ route('accountant.add-manage-expense.print', $expense->id) }}?auto_print=1" target="_blank" class="btn btn-sm btn-dark px-2 py-1" title="Print voucher (opens print dialog)">
