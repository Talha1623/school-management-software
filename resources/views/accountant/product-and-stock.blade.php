...
@section('title', 'Product and Stock - Accountant')
        ...
        <div class="card bg-white border border-white rounded-10 p-3 mb-4">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3 mb-3 p-3 rounded-8" style="background-color: #f8f9fa; border: 1px solid #e9ecef;">
                ...
                <div class="d-flex align-items-center gap-2 flex-wrap">
                    ...
                    <div class="d-flex gap-2">
                        <a href="{{ route('accountant.product-and-stock.export', ['format' => 'excel']) }}{{ request()->has('search') && request('search') ? '?' . http_build_query(request()->only(['search'])) : '' }}" class="btn btn-sm px-2 py-1 export-btn excel-btn">
                            <span class="material-symbols-outlined" style="font-size: 14px; vertical-align: middle;">description</span>
                            <span>Excel</span>
                        </a>
                        <a href="{{ route('accountant.product-and-stock.export', ['format' => 'pdf']) }}{{ request()->has('search') && request('search') ? '?' . http_build_query(request()->only(['search'])) : '' }}" class="btn btn-sm px-2 py-1 export-btn pdf-btn" target="_blank">
            ...
            @if(request('search'))
                <div class="search-results-info">
                    ...
                    @endif
                    <a href="{{ route('accountant.product-and-stock') }}" class="text-decoration-none ms-2" style="color: #003471;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <div class="d-inline-flex gap-1 align-items-center">
                                                ...
                                                <form id="delete-form-{{ $product->id }}" action="{{ route('accountant.product-and-stock.destroy', $product->id) }}" method="POST" class="d-none">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </div>
...
<div class="modal fade" id="productModal" tabindex="-1" aria-labelledby="productModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 12px; overflow: hidden;">
            ...
            <form id="productForm" method="POST" action="{{ route('accountant.product-and-stock.store') }}">
                @csrf
...
function resetForm() {
    ...
    document.getElementById('productForm').action = "{{ route('accountant.product-and-stock.store') }}";
