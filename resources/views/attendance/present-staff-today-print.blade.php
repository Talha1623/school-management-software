...
<head>
    ...
    <title>Present Staff Today</title>
    <style>
...
<body>
    <div class="header">
        <div>
            <h1 class="title">Present Staff Today</h1>
    ...
    <table>
        ...
        <tbody>
            @forelse($records as $index => $attendance)
                @php $staff = $attendance->staff; @endphp
                <tr>
                    <td>{{ $index + 1 }}</td>
            ...
            @empty
                <tr>
                    <td colspan="6" class="empty">No present staff found.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
