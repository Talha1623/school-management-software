...
<head>
    ...
    <title>Staff Attendance Summary</title>
    <style>
...
<div class="print-container">
    <div class="header-section">
        ...
        <div class="meta">Period: {{ $monthLabel }} &nbsp;|&nbsp; Generated: {{ $printedAt }} &nbsp;|&nbsp; Staff: {{ $summary->count() }}</div>
    </div>
    ...
    <div class="table-wrap">
        <table>
            ...
            <tr>
                ...
                <th style="width:10%;">Father/Husband</th>
                <th style="width:8%;">Campus</th>
                <th style="width:10%;">Designation</th>
                <th class="num" style="width:7%;">Present</th>
                <th class="num" style="width:7%;">Absent</th>
                <th class="num" style="width:7%;">Leave</th>
                <th class="num" style="width:7%;">Late</th>
                <th class="num" style="width:8%;">Attendance %</th>
            </tr>
            </thead>
            <tbody>
            ...
            @empty
                <tr>
                    <td colspan="11" style="text-align:center;color:#6b7280;">No staff found.</td>
                </tr>
            @endforelse
            </tbody>
        </table>
    ...
    <div class="footer-section">
        <div>
            <strong>Total staff (listed):</strong> {{ $summary->count() }}
            &nbsp;|&nbsp;
            <span style="font-size:10px;color:#6b7280;">% = Present ÷ (Present + Absent) for the month; all active staff included.</span>
        </div>
